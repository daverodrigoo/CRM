...
const emptyForm = {
  Lead_ID: '', Acquisition_Date: '', Business_Name: '', 
...
// --- SCHEDULE APPOINTMENT LOGIC ---
  const handleScheduleClick = (lead) => {
    ...
    if (hasInquiry && hasResponded && hasPOC && isCompleted) {
      ...
      alert("Cannot schedule yet. The lead must have an Inquiry Type, Point of Contact, Responded = Yes, and Completed = True.");
    }
  };
                    ...
                    <td className="px-4 py-3 text-center">
                        <button 
                          ...
                          className={`p-1.5 rounded-md transition-colors ${
                            lead.Meeting_Date 
                              ? 'text-[#19a828]'  
                              : 'text-[#7E3A99] hover:text-[#19a828] hover:bg-green-50'
                          }`}
                          title={lead.Meeting_Date ? "Update Appointment" : "Schedule Appointment"}
                        >
